...
/* TASK 1 */
select salary, 0.15*salary+salary "Updated Salary"
from employees 
where salary > 15000
...
/* TASK 3 */
select employee_id, CONCAT(first_name,' ', last_name) as "Name", email, phone_number, hire_date, job_id, salary, manager_id, department_id
from employees


/* TASK 4 */
select employee_id,first_name,last_name,email,phone_number,hire_date, datediff(day,hire_date,'2021/05/27') as "Days worked",job_id,salary,manager_id,department_id
from employees
...
from employees
where salary < 10000 and first_name like 'd%' 

/* TASK 6 */
select employee_id,first_name,last_name,email,phone_number
from employees
where phone_number like '%9%' and last_name like '%a'
